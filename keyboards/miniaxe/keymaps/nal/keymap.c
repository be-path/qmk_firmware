...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_split_3x5_3( \
    ...
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,   KC_COMM, KC_DOT,  LSFT_T(KC_SLSH), \
                      KC_LALT, KC_LGUI, KC_LSFT,      KC_MINS, KC_SPC, KC_TAB \
  ),
  [_LOWER] = LAYOUT_split_3x5_3( \
    IMEOFF, IMEON, KC_LBRC, KC_RBRC, KC_QUOT,      KC_ESC,  KC_HOME, KC_UP,   KC_DEL,   KC_ENT, \
    KC_LT,  KC_GT, KC_LCBR, KC_RCBR, KC_DQUO,      KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, LCTL_T(KC_END), \
    KC_NO,  KC_NO, KC_LPRN, KC_RPRN, KC_NO,        KC_BSPC,  KC_NO,   KC_NO,   KC_DEL,   _______, \
                  _______, _______, _______,      _______,  _______, _______ \
  ),
  [_RAISE] = LAYOUT_split_3x5_3( \
    KC_NO, KC_7, KC_8, KC_9, KC_NO,      KC_GRV, KC_AMPR, KC_ASTR, KC_BSLS, KC_NO, \
    KC_NO, KC_4, KC_5, KC_6, KC_NO,      KC_EQL, KC_DLR,  KC_PERC, KC_CIRC, KC_NO, \
    KC_0,  KC_1, KC_2, KC_3, KC_NO,      KC_NO,  KC_EXLM, KC_AT,   KC_HASH, KC_NO, \
                      _______, _______, _______,      _______, _______, _______ \
  ),
