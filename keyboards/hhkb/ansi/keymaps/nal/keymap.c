...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_LANG1, KC_LANG2,
    ...
    [KL_ARROW] = LAYOUT(
        ...
        KC_TRNS, KC_NO, KC_NO, KC_SCLN, KC_QUOT, KC_NO, KC_NO, KC_NO, KC_UP, KC_DEL, KC_NO, KC_NO, KC_NO, KC_TRNS,
